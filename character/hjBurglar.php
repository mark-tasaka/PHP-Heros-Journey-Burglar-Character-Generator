...
<html>
<head>
<title>Hero's Journey Burglar Character Generator Version 3</title>
 
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js"></script>
    
	<meta charset="UTF-8">
	<meta name="description" content="Hero's Journey Burglar Character Generator. Gallant Knight Games.">
	...
	<link rel="stylesheet" type="text/css" href="css/burglar.css">
...
<!-- JQuery -->
  ...
  <script>
        ...
        let imgData = "images/burglar.png";
